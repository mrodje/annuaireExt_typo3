...
plugin.tx_annuairematthiasrodier_keylistandshowcontact {
  view {
    # cat=plugin.tx_annuairematthiasrodier_keylistandshowcontact/file; type=string; label=Path to template root (FE)
    templateRootPath = EXT:annuaire_matthias_rodier/Resources/Private/Templates/
    # cat=plugin.tx_annuairematthiasrodier_keylistandshowcontact/file; type=string; label=Path to template partials (FE)
    partialRootPath = EXT:annuaire_matthias_rodier/Resources/Private/Partials/
    # cat=plugin.tx_annuairematthiasrodier_keylistandshowcontact/file; type=string; label=Path to template layouts (FE)
    layoutRootPath = EXT:annuaire_matthias_rodier/Resources/Private/Layouts/
  }
  persistence {
    # cat=plugin.tx_annuairematthiasrodier_keylistandshowcontact//a; type=string; label=Default storage PID
    storagePid =
  }
}
...
plugin.tx_annuairematthiasrodier_keylistandshoworganisme {
  view {
    ...
    templateRootPath = EXT:annuaire_matthias_rodier/Resources/Private/Templates/
    # cat=plugin.tx_annuairematthiasrodier_keylistandshoworganisme/file; type=string; label=Path to template partials (FE)
    partialRootPath = EXT:annuaire_matthias_rodier/Resources/Private/Partials/
    # cat=plugin.tx_annuairematthiasrodier_keylistandshoworganisme/file; type=string; label=Path to template layouts (FE)
    layoutRootPath = EXT:annuaire_matthias_rodier/Resources/Private/Layouts/
  }
  persistence {
